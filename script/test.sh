...
description "For test purpose we will execute 'dummy' program that sleeps as demanded by param"
    ...
    description "This jobs will not be executed because the shutdown will be called first"
        testTitle "Execute './dummy' with sleep: 1s and delay: 80s"
            run "execute 1 ./dummy" &
        testTitle "Execute './dummy' with sleep: 1s and delay: 90s"
            run "execute 1 ./dummy" &
        testTitle "Execute './dummy' with sleep: 1s and delay: 100s"
            run "execute 1 ./dummy"
